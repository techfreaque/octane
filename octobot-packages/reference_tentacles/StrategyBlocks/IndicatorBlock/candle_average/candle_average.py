...
class CandleAverageIndicator(abstract_indicator_block.IndicatorBlock):
    NAME = "candle_average"
    TITLE = "Candle Average"
    TITLE_SHORT = "Candle Average"
    DESCRIPTION = "Candle Average"
    candle_source: str
    ...
    async def execute_block(
        ...
        candle_open = await self.get_candles(matrix_enums.PriceDataSources.OPEN.value)
        data = (candle_high + candle_low + candle_close + candle_open) / 4
