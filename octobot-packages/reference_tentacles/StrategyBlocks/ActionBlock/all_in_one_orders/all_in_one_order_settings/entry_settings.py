...
import tentacles.StrategyBlocks.ActionBlock.all_in_one_orders.all_in_one_order_settings.entry_types as entry_types
...
class ManagedOrderSettingsEntry:
    ...
    def _limit_order_expiration_user_input(self, order_block, entry_setting_name: str):
