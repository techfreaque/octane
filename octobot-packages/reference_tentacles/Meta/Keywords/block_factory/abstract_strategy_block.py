...
class StrategyBlock(abstract_block.AbstractBlock):
    ...
    TRIGGER_SOURCES: typing.Tuple[str] = (enums.ActivationTopics.FULL_CANDLES.value,)
    strategy_id: int
...
class StrategySignals:
    ...
    def add_signals(self, signals, signals_title: str):
