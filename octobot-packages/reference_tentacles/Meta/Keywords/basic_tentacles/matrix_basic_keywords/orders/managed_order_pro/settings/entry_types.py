class ManagedOrderSettingsEntryTypes:
    ...
    SCALED_DYNAMIC = "dynamic"
    SCALED_INDICATOR = "indicator"
    ...
    SCALED_INDICATOR_DESCRIPTION = "Scale limit orders over a indicator based range"
    ...
    LIMIT_ENTRY_TYPES = [
        ...
        SCALED_INDICATOR_DESCRIPTION,
        SCALED_OVER_TIME_DESCRIPTION,
        SCALED_STATIC_DESCRIPTION,
    ]

    DESCRIPTIONS_TO_KEY = {
        SINGLE_MARKET_IN_DESCRIPTION: SINGLE_MARKET_IN,
        SINGLE_LIMIT_IN_DESCRIPTION: SINGLE_LIMIT_IN,
        SINGLE_TRY_LIMIT_IN_DESCRIPTION: SINGLE_TRY_LIMIT_IN,
        SCALED_OVER_TIME_DESCRIPTION: SCALED_OVER_TIME,
        SCALED_DYNAMIC_DESCRIPTION: SCALED_DYNAMIC,
        SCALED_INDICATOR_DESCRIPTION: SCALED_INDICATOR,
        SCALED_STATIC_DESCRIPTION: SCALED_STATIC,
    }
    DESCRIPTIONS = [
