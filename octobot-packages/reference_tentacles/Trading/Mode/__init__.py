...
if check_tentacle_version('1.0.1', 'semi_auto_trading_mode', 'Semi-Auto-Trading-Mode'):
    try:
...
if check_tentacle_version('0.8.2', 'spot_master_3000_trading_mode', 'Spot-Master-3000'):
    try:
...
if check_tentacle_version('1.5.0', 'strategy_maker_trading_mode', 'Matrix-Strategy-Maker'):
    try:
...
if check_tentacle_version('1.0.0', 'strategy_flow_maker_mode', 'Matrix-Strategy-Maker'):
    try:
...
if check_tentacle_version('1.1.2', 'lorentzian_classification', 'Lorentzian-Classification'):
    try:
