...
if check_tentacle_version('1.2.0', 'time_frame_strategy_evaluator', 'OctoBot-Default-Tentacles'):
    try:
...
if check_tentacle_version('1.2.0', 'real_time_strategy_evaluator', 'OctoBot-Default-Tentacles'):
    try:
