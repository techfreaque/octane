...
class VectorAdditionIndicator(abstract_indicator_block.IndicatorBlock):
    NAME = "vector_addition"
    TITLE = "Vector Addition"
    TITLE_SHORT = "Vector Addition"
    ...
    async def execute_block(
        ...
        await self.store_indicator_data(
            title=f"{self.TITLE_SHORT} {self.candle_source_low} {self.candle_source_high}",
            data=data,
        )
