...
class SpecialHighsIndicator(abstract_indicator_block.IndicatorBlock):
    NAME = "special_highs"
    TITLE = "Special Highs"
    TITLE_SHORT = "Special Highs"
    DESCRIPTION = "Special Highs"

    multiplicator: float

    def init_block_settings(self) -> None:
        self.multiplicator = self.user_input("Special highs multiplicator", "float", 2)
