...
class AdmrIndicator(abstract_indicator_block.IndicatorBlock):
    NAME = "admr"
    TITLE = "Average Directional Movement Rating"
    TITLE_SHORT = "ADMR"
    DESCRIPTION = "Average Directional Movement Rating"

    length: int

    def init_block_settings(self) -> None:
        self.length = self.user_input(
            "Average Directional Movement Rating length", "int", 50, 0
        )
